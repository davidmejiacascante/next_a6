...
CREATE TABLE `departamento` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Departamentos de la empresa';
...
INSERT INTO `departamento` VALUES (1,'Comercial'),(2,'Credito'),(3,'Riesgo'),(4,'Gerencia'),(5,'Operaciones'),(6,'Direccion'),(7,'IT'),(8,'Talento Humano'),(9,'Atencion al Cliente');
